...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])) {
	...
	$C = $_POST['Cukup'];
	$K = $_POST['Kurang'];
	$queryEdit = mysqli_query($con,"UPDATE pb_tw SET baik='$B', cukup='$C', kurang='$K' WHERE id_pbtw=2");
	...
	$query = mysqli_query($con, "SELECT * FROM pb_tw WHERE id_pbtw=2");
	...
	if ($queryEdit) {
		...
		mysqli_query($con, "UPDATE s_tw SET b = '$baik', c = '$ckp', k = '$krg', j = '$jml', p = '$prioritas' WHERE id_stw = 2");
