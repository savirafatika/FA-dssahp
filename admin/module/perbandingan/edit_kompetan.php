...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])) {
	...
	$Kr = $_POST['Kr'];
	$Tdk = $_POST['Tdk'];
	$queryEdit = mysqli_query($con,"UPDATE pb_tm SET kompeten='$Kp', kurang='$Kr', tidak='$Tdk' WHERE id_pbtm=1");
	...
	$query = mysqli_query($con, "SELECT * FROM pb_tm WHERE id_pbtm=1");
	...
	if ($queryEdit) {
		...
		mysqli_query($con, "UPDATE s_tm SET kp = '$Kom', kr = '$Kur', tdk = '$Tid', j = '$jml', p = '$prioritas' WHERE id_stm = 1");
